...
struct mg_connection *MongooseConnection::getInfo() const
{
    return m_conn;
}
...
const std::string MongooseRequest::getXHRData() const {
#ifdef DEBUG
	std::cout << "XHRData: " << m_info->data << std::endl;
#endif
    return std::string(m_info->data);
}
