 ...
 */
extern int stringtokenizer_next_token(stringtokenizer stringtokenizer, const char* delims, int numofdelims, char* dst);
extern int stringtokenizer_next_token2(stringtokenizer tokenizer, const char* delims, int numofdelims, char* dst, char* delim);
